package com.fburaky.kotlinfirebaseinsta
...
class MainActivity : AppCompatActivity() {
    ...
    fun signInClicked(view : View) {
        ...
        auth.signInWithEmailAndPassword(userEmailText.text.toString(),userPasswordText.text.toString()).addOnCompleteListener { task ->
